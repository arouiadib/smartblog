...
define('_MODULE_SMARTBLOG_VERSION_', '4.0.9');
...
class smartblog extends Module
{
	...
	// 	if ($template_file === 'module:smartblog/posts') {
	// 		return 'module:smartblog/views/templates/front/pro.tpl';
	// 	}
                ...
                <div class="dashboard-presents-product-bottom-content">
                    ...
                    <div class="dashboar-single-presents-item db-second-item">
                        <a href="https://classydevs.com/slider-revolution-prestashop/" target="_blank">
                            <img src="<?php echo _MODULE_SMARTBLOG_IMAGE_URL_ . 'slider-rev-banner-2.png'; ?>"
                                alt="Logo">
                        </a>
                    </div>
                </div>
	...
	public function SettingForm()
	{
		...
		$this->fields_form[0]['form'] = array(
			...
			'input'  => array(
				...
				array(
					'type'     => 'switch',
					'label'    => $this->l('Index in Serch Engine'),
